    ...
    private fun getNearbyDrivers() {
        ...
        geoProvider.getNearbyDrivers(myLocationLatLng!!, 20.0).addGeoQueryEventListener(object : GeoQueryEventListener{
            ...
            override fun onKeyEntered(documentID: String, location: GeoPoint) {
                ...
                //se crea marcador para el conductor conectado
                val driverLatLng = LatLng(location.latitude, location.longitude)
                val marker = googleMap?.addMarker(MarkerOptions().position(driverLatLng)
                    .title("Conductor disponible.").icon(BitmapDescriptorFactory.fromResource(R.drawable.taxi1)))
